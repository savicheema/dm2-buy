...
export default function PackageExtraDetails(props) {
  const { instaUserId, dispatchTime, style } = props;
  return (
    <div className={orderStyles.orderInfoContainer} style={style}>
      ...
      <div className={orderStyles.orderInfo}>
        ...
        <h6 className={orderStyles.orderInfoDiscription}>
          DM me on ig{" "}
          <a
            className={orderStyles.linkBorder}
            href={"https://www.instagram.com/" + instaUserId}
            rel="noreferrer"
            target="_blank"
          >
            {instaUserId}
